...
namespace SchoolManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260922170636_UpdateNotificationRecipientConstraint")]
    partial class UpdateNotificationRecipientConstraint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.ClassTeacherAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AcademicYearId", "SchoolClassId", "StaffId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.Notification", b =>
                {
                    ...
                    b.Property<int?>("RecipientParentGuardianId")
                        .HasColumnType("int");

                    b.Property<int?>("RecipientStaffId")
                        .HasColumnType("int");

                    b.Property<int?>("RecipientStudentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RecipientParentGuardianId");

                    b.HasIndex("RecipientStaffId", "IsRead", "CreatedAt");

                    b.HasIndex("RecipientStudentId", "IsRead", "CreatedAt");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.ParentDeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ParentGuardianId", "IsActive");

                    b.ToTable("ParentDeviceTokens");
                });

            modelBuilder.Entity("SchoolManagement.Domain.Entities.ParentGuardian", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.SchoolAnnouncement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.SpecialClassSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClassDate", "SchoolClassId", "StartTime");

                    b.HasIndex("StaffId", "ClassDate", "StartTime");

                    b.ToTable("SpecialClassSessions");
                });
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.StaffDeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.StaffPasswordResetCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StaffId", "IsActive", "IsUsed");

                    b.ToTable("StaffPasswordResetCodes", (string)null);
                });
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.StudentAcademicEnrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudentAcademicEnrollments");
                });
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.StudentDeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.StudentParentGuardian", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StudentId", "ParentGuardianId")
                        .IsUnique();

                    b.ToTable("StudentParentGuardians");
                });

            modelBuilder.Entity("SchoolManagement.Domain.Entities.StudentPromotionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudentPromotionHistories");
                });

            modelBuilder.Entity("SchoolManagement.Domain.Entities.StudentRegistrationCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.TemporaryClassTeacherAccessRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("TemporaryClassTeacherAssignmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TemporaryClassTeacherAssignmentId");

                    b.ToTable("TemporaryClassTeacherAccessRequests");
                });

            modelBuilder.Entity("SchoolManagement.Domain.Entities.TemporaryClassTeacherAssignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TemporaryClassTeacherAssignments");
                });
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.TimetableEntry", b =>
                {
                    ...
                    b.HasIndex("StaffId", "Day", "StartTime");

                    b.HasIndex("AcademicYearId", "AcademicTermId", "SchoolClassId", "Day", "StartTime");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.ClassTeacherAssignment", b =>
                {
                    ...
                    b.HasOne("SchoolManagement.Domain.Entities.Staff", "AssignedByStaff")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.Notification", b =>
                {
                    b.HasOne("SchoolManagement.Domain.Entities.ParentGuardian", "RecipientParentGuardian")
                        .WithMany()
                        .HasForeignKey("RecipientParentGuardianId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SchoolManagement.Domain.Entities.Staff", "RecipientStaff")
                        .WithMany()
                        .HasForeignKey("RecipientStaffId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("SchoolManagement.Domain.Entities.Student", "RecipientStudent")
                        .WithMany()
                        .HasForeignKey("RecipientStudentId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("RecipientParentGuardian");
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.ParentDeviceToken", b =>
                {
                    b.HasOne("SchoolManagement.Domain.Entities.ParentGuardian", "ParentGuardian")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.SchoolAnnouncement", b =>
                {
                    b.HasOne("SchoolManagement.Domain.Entities.Staff", "CreatedByStaff")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.SpecialClassSession", b =>
                {
                    ...
                    b.HasOne("SchoolManagement.Domain.Entities.Staff", "CancelledByStaff")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.StudentAttendance", b =>
                {
                    ...
                    b.HasOne("SchoolManagement.Domain.Entities.Staff", "MarkedByStaff")
                        .WithMany()
                        .HasForeignKey("MarkedByStaffId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.StudentPromotionHistory", b =>
                {
                    b.HasOne("SchoolManagement.Domain.Entities.AcademicYear", "FromAcademicYear")
                        .WithMany()
                        .HasForeignKey("FromAcademicYearId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SchoolManagement.Domain.Entities.SchoolClass", "FromSchoolClass")
                        .WithMany()
                        .HasForeignKey("FromSchoolClassId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SchoolManagement.Domain.Entities.Staff", "ProcessedByStaff")
                        .WithMany()
                    ...
                    b.HasOne("SchoolManagement.Domain.Entities.AcademicYear", "ToAcademicYear")
                        .WithMany()
                        .HasForeignKey("ToAcademicYearId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SchoolManagement.Domain.Entities.SchoolClass", "ToSchoolClass")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolManagement.Domain.Entities.TemporaryClassTeacherAccessRequest", b =>
                {
                    ...
                    b.HasOne("SchoolManagement.Domain.Entities.Staff", "RequestedByStaff")
                        .WithMany()
                    ...
                    b.HasOne("SchoolManagement.Domain.Entities.TemporaryClassTeacherAssignment", "TemporaryClassTeacherAssignment")
                        .WithMany()
                        .HasForeignKey("TemporaryClassTeacherAssignmentId")
                        .OnDelete(DeleteBehavior.NoAction);
                    ...
                    b.Navigation("TemporaryClassTeacherAssignment");
                });
